            ...
            <div className="w-full flex flex-col justify-center items-center py-24 login-part">
                <div className="flex flex-col shadow-md rounded-xl border-2 border-gray-200 md:py-5 md:px-5  py-4 px-4">
                    ...
                    <form onSubmit={(e)=>signInWithEmail(e)} className="flex flex-col">
                        <p className="py-2 mt-10 px-3 shadow-md border-2 border-gray-200 rounded-lg mb-3"><i class="fas fa-at mr-2"></i> <input type="email" onBlur={handleEmail}  placeholder="Enter your email" className="md:w-72 w-54 outline-none border-l-2 border-gray-500 pl-2 text-gray-700 font-base font-semibold " /></p>
