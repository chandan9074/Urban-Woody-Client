    ...
    return ( 
        <div className="relative footer-back">
            ...
            <div className="container flex justify-between">
                <div className="z-10 mt-20 footer-details w-7/12 flex flex-col">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between mt-3">
                        ...
                        <p className=" py-2 px-2 m-0 bg-gray-600 flex"><i class="fas fa-at text-gray-400"></i> <input className="text-gray-200 md:ml-2 ml-4 outline-none md:w-60 w-20  bg-transparent" type="email" placeholder="Enter your email" /></p>
                ...
                <div>
                    <h1 className="mt-16 text-right">urban woody</h1>
